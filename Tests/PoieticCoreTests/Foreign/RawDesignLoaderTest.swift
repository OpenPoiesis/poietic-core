...
struct DesignLoaderReservationTests {
    ...
    @Test func createNewStrategy() async throws {
        let resolution = DesignLoader.ValidationResolution(
            identityManager: strayIdentityManager,
            rawSnapshots: [
                RawSnapshot(),
    ...
    @Test func requireProvidedStrategy() async throws {
        let resolution = DesignLoader.ValidationResolution(
            identityManager: strayIdentityManager,
            rawSnapshots: [
    ...
    @Test func requireProvidedStrategyConflict() async throws {
    ...
    @Test func requireProvidedUnavailableObjectID() async throws {
        let resolution = DesignLoader.ValidationResolution(
            identityManager: strayIdentityManager,
            rawSnapshots: [
    ...
    @Test func preserveOrCreateStrategy() async throws {
    ...
    @Test func preserveOrCreateWithUnavailableObjectID() async throws {
        let resolution = DesignLoader.ValidationResolution(
            identityManager: strayIdentityManager,
            rawSnapshots: [
                RawSnapshot(id: .int(10)),
    ...
    @Test func reservationOrderingBug() async throws {
...
//        let raw = RawDesign(
//            snapshots: [
//                RawSnapshot(typeName: nil, snapshotID: ForeignEntityID.int(10)),
//            ],
//            frames: [
...
//        let raw = RawDesign(
//            snapshots: [
//                RawSnapshot(typeName: "Unknown", snapshotID: ForeignEntityID.int(10)),
//            ],
//            frames: [
//                RawFrame(snapshots: [.int(10)])
//            ]
