...
public enum BasicDomain {
    ...
    public enum Types {
        ...
        public static let BibliographicalReference = ObjectType(
            ...
            topologyType: .unstructured,
            traits: [
                Traits.BibliographicalReference,
                Traits.Orderable,
            ])
    ...
    /// kinds of designs.
    ///
    public static let BasicMetamodel = Metamodel(
        name: "Basic",
        traits: [
            Traits.Name,
            Traits.DesignInfo,
            ...
            Traits.Note,
            Traits.BibliographicalReference,
            DiagramDomain.Traits.DiagramView,
        ],
        types: [
            DiagramDomain.Types.DiagramSettings,
            Types.DesignInfo,
            Types.Group,
        ],
        constraints: []
