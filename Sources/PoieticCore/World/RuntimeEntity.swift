...
///
/// - Important: Runtime entity handles must not be held longer than the world they point to.
///   Make sure to dispose of all handles when you are disposing of the world.
///
