...
public final class Constraint: Sendable {
    ...
    ///
    public func check(_ frame: some DesignProtocol) -> [ObjectID] {
...
public protocol ConstraintRequirement: Sendable {
    ...
    func check(frame: some DesignProtocol, objects: [ObjectSnapshot]) -> [ObjectID]
}
...
public final class AllSatisfy: ConstraintRequirement {
    ...
    public func check(frame: some DesignProtocol, objects: [ObjectSnapshot]) -> [ObjectID] {
