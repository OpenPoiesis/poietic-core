...
//  poietic-core
//
//  Created by Stefan Urbanek on 27/03/2026.
//
...
public struct DisplayValueBounds: Component {
    ...
    public init(from object: ObjectSnapshot) {
        ...
        if autoscale == true {
            ...
            self.min = object["display_value_min"]
            self.max = object["display_value_max"]
            self.baseline = object["display_value_baseline"]
        }
    }
}


/// Specifies bounds of possible values for a metric, including baseline.
